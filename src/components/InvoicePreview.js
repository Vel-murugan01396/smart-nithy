...
//   const customerGST = `33ABCDE${Math.floor(1000 + Math.random() * 9000)}F1Z5`;
...
//           <div>
//             <h2 className="font-bold text-lg sm:text-xl">Tax Invoice</h2>
//             <p className="text-xs sm:text-sm">Invoice No: {invoiceNo}</p>
